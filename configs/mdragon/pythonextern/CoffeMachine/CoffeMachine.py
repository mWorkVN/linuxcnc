...
class WaitChooseItemState(State):
    ...
    def checkAndChangeState(self):
        ...
        self.radio.state = self.radio.insertAmountForItemState
...
class showItemsState(State):
    ...
    def checkAndChangeState(self):
        ...
        self.radio.state = self.radio.WaitChooseItemState
...
class insertAmountForItemState(State):
    ...
    def checkAndChangeState(self):
        ...
        self.radio.state = self.radio.checkRefundState
class checkRefundState(State):
    ...
    def checkAndChangeState(self):
        ...
        self.radio.state = self.radio.showItemsState
