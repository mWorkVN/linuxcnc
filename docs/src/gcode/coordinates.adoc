...
Missing in src/gcode/coordinates.adoc but seems nice in French 1.

Missing in src/gcode/coordinates.adoc but seems nice in French 2.
...
image::images/offsets.png["Example of Coordinate Systems",align="center"]
