...
=== Single-File G-code (.ngc) Subroutine Requirements
...
=== G-code-meta-compiler (.gcmc) file requirements
Files for the G-code-meta-compiler (gcmc) are read by ngcgui and it
